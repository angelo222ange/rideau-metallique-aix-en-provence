...
export default function FloatingCallButton() {
  ...
  const label = siteConfig.phonePublic && siteConfig.phone ? `Appeler ${siteConfig.phone}` : "Devis gratuit";
  const isTel = siteConfig.phonePublic && siteConfig.phone;

  return (
    <a
      href={href}
      aria-label={isTel ? `Appeler le ${siteConfig.phone}` : "Demande de devis"}
