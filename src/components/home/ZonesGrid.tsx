      ...
      <div className="max-w-[1280px] mx-auto flex flex-col items-center gap-10 md:gap-12">
        <div className="flex flex-col items-center text-center gap-4 max-w-[820px]">
          ...
          <h2 className="text-[#181C16]">
            DRM {siteConfig.city} couvre toute le Pays d'Aix et le sud-Landes
          </h2>
        ...
        <Link
          href="/zones/"
          className="inline-flex items-center justify-center h-12 px-7 bg-[#2D3F2A] hover:bg-[#073640] text-white text-[15px] font-semibold rounded-[8px] transition-colors"
        >
