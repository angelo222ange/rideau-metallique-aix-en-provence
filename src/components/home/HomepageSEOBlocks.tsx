...
const blocks: SEOBlock[] = [
  {
    ...
    title: `${siteConfig.experience} ans d'expertise au service du rideau metallique en Pays d'Aix`,
    paragraphs: [
      `DRM ${siteConfig.city} intervient depuis plus de ${siteConfig.experience} ans sur le rideau metallique des commerces, ateliers et industriels du Pays Aixois. Notre atelier de fabrication est situe en Pays d'Aix, ce qui nous permet de produire des lames, axes et coulisses sur-mesure en quelques heures pour les cas urgents.`,
      `Notre equipe couvre l'integralite du secteur de Aix-en-Provence, Les Milles, Gardanne (Pays d'Aix) ainsi que les communes de Le Tholonet, Lambesc, Trets, Eguilles et les villages provencaux alentour. Chaque technicien DRM est forme aux dernieres normes constructeurs et aux specificites locales : exposition au mistral et au soleil provencal, contraintes des batiments historiques aixois.`,
      `Cette implantation locale change tout : <strong>delai d'intervention sous ${siteConfig.delai} minutes</strong> en horaires ouvrables, fabrication sur-mesure en moins de 4 heures, connaissance des contraintes d'acces et des reglementations communales. ${siteConfig.brand} est l'acteur historique du <strong>depannage de rideau metallique</strong> au Pays Aixois.`,
    ],
  ...
  },
  {
    ...
    paragraphs: [
      ...
      `Chaque service est assure par les memes techniciens DRM ${siteConfig.city}, ce qui garantit une continuite parfaite : le professionnel qui installe votre rideau metallique aujourd'hui sera disponible demain pour le depanner ou l'entretenir. Cette logique de proximite est aujourd'hui rare en Pays d'Aix, ou la plupart des intervenants sous-traitent ou font tourner les equipes.`,
      `Nos contrats d'entretien annuels couvrent jusqu'a 4 visites par an avec verification complete (axe, ressorts, moteur, coulisses, serrure). Resultat : 60 % de pannes en moins constatees chez nos clients sous contrat. Decouvrez nos <Link href="/depannage-rideau-metallique-${citySlug}/">interventions de depannage</Link> ou consultez le detail de chaque service.`,
    ],
